  ...
  --> */}
	...
	<div className="fixed inset-0 z-10 w-screen overflow-y-auto">
      ...
      --> */}
			...
			<div onSubmit={(e)=> { e.preventDefault() }} className="relative transform rounded-lg bg-white p-8 shadow-xl
				transition-all sm:my-8 sm:w-full sm:max-w-lg">
				<AiFillCloseCircle className="absolute right-8 top-8 " />
				...
				<button type="button"
					className="inline-flex w-full mt-6 justify-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 sm:ml-3 sm:w-auto">Book</button>
